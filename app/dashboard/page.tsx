...
function getPaketTheme(nama: string): PaketTheme {
  ...
  if (n.includes("smk")) return {
    ...
    tag:   "Kejuruan",
    desc:  "PPKN · PKK",
    // Siswa SMK berseragam di kelas/upacara
            ...
            <div className="relative z-10 flex items-center justify-between gap-3">
              <div className="min-w-0">
                <div className="inline-flex items-center gap-1.5 bg-[#6366F1]/15 border border-[#6366F1]/20 rounded-full px-2.5 py-0.5 mb-2">
                  ...
                  <span className="text-[9px] font-bold tracking-widest text-[#818CF8] uppercase">
                    Selamat Datang
                  </span>
                </div>
                    ...
                    >
                      ...
                      <div className="relative w-full overflow-hidden" style={{ aspectRatio: "4/3" }}>
                        <img
                          ...
                          loading="lazy"
                        />
                        {/* Overlay gradient — tipis agar foto tetap keliatan */}
                        <div className={`absolute inset-0 bg-gradient-to-t ${theme.bg} opacity-70`} />

                        {/* Icon */}
                        <div
                          className="absolute top-1.5 left-1.5 md:top-2.5 md:left-2.5 w-6 h-6 md:w-8 md:h-8 rounded-lg flex items-center justify-center text-sm md:text-base backdrop-blur-sm border border-white/20"
                        ...
                        {/* Tag */}
                        <div
                          className={`absolute top-1.5 right-1.5 md:top-2.5 md:right-2.5 text-[8px] md:text-[9px] font-bold px-1.5 py-0.5 rounded-md border backdrop-blur-sm ${theme.badge}`}
                        >
                          {theme.tag}
                        </div>
                      </div>
                      ...
                      <div className="p-2 md:p-3">
                        ...
                        <p className="text-white/40 text-[9px] md:text-[10px] mt-0.5 truncate">
                          {theme.desc}
                        </p>
                        ...
                        <div
                          ...
                          style={{
                            background: `linear-gradient(135deg, ${theme.accent}99, ${theme.accent}60)`,
